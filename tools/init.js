...
var _b = require("fs"),
  ...
  writeFileSync = _b.writeFileSync;
var fork = require("child_process").fork;
// Note: These should all be relative to the project root directory
var rmDirs = [".git"];
var rmFiles = [".all-contributorsrc", ".gitattributes"];
var modifyFiles = [
  "LICENSE",
  "package.json",
  "rollup.config.ts",
...
function modifyContents(libraryName, username, usermail) {
  ...
  var files = modifyFiles.map(function(f) {
    return path.resolve(__dirname, "..", f);
  });
  try {
